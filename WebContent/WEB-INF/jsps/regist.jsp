	...
	$(function() {
		$("#registerForm").submit(function() {
			...
			if (username == "") {
				...
				td.append("<font color='red'>&nbsp;&nbsp;用户名不能为空</font>");
				return false;
			}
			//判断密码是否为空
			var password = $("#password").val();
			if (password == "") {
				var td = $("#password").parent();
				td.append("<font color='red'>&nbsp;&nbsp;密码不能为空</font>")
				return false;
			}
			var rePassword = $("#rePassword").val();
			if (rePassword == "") {
				var td = $("#rePassword").parent();
				td.append("<font color='red'>&nbsp;&nbsp;密码不能为空</font>")
				return false;
			}
			//判断两次密码输入是否一致
			if (password != rePassword) {
				var td = $("#rePassword").parent();
				td.append("<font color='red'>&nbsp;&nbsp;两次输入的密码不一致</font>")
				return false;
			}
		});
		$("#username")
				.blur(
						function() {
							var url = "${pageContext.request.contextPath}/user_validateUserName";
							var username = $("#username").val();
							var args = {
								"userName" : username,
								"time" : new Date()
		...
		$("#verifyCodeImg").click(function(){
			$("#verifyCodeImg").attr("src","${pageContext.request.contextPath}/verifyCode?" + new Date());
		})	 
								...
								<tbody>
									<tr>
										...
										<td><input type="text" id="username" name="userName"
											class="text" maxlength="20" /><font color="red"> <s:fielderror
													fieldName="userName" /></font></td>
									</tr>
									<tr>
										<th><span class="requiredField">*</span>密&nbsp;&nbsp;码:</th>
										<td><input type="password" id="password" name="password"
											class="text" maxlength="20" autocomplete="off" /> <font
											color="red"><s:fielderror fieldName="password" /> </font></td>
									</tr>
									<tr>
										<th><span class="requiredField">*</span>确认密码:</th>
										<td><input type="password" id="rePassword"
											name="rePassword" class="text" maxlength="20"
											autocomplete="off" /> <font color="red"> <s:fielderror
									...
									<tr>
										...
										<td><input type="text" id="email" name="email"
											class="text" maxlength="200" /> <font color="red"> <s:fielderror
													fieldName="email" /></font></td>
									</tr>
									<tr>
										<th>姓名:</th>
										<td><input type="text" name="realName" class="text"
											maxlength="200" /> <font color="red"> <s:fielderror
													fieldName="realName" /></font></td>
									</tr>
									<tr>
										<th>手机:</th>
										<td><input type="text" name="phone" class="text"
											maxlength="200" /> <font color="red"> <s:fielderror
													fieldName="phone" /></font></td>
									</tr>
									<tr>
										<th>性别:</th>
										<td><span class="fieldSet"> <label> <input
													type="radio" name="gender" value="male" checked="checked" />男
									...
									<tr>
										<th>出生日期:</th>
										<td><input type="text" name="birthdate" class="text" />
											<font color="red"> <s:fielderror fieldName="birthdate" /></font></td>
									</tr>
									...
									<tr>
										...
										<td><input type="text" name="address" class="text"
											maxlength="200" /> <font color="red"> <s:fielderror
													fieldName="address" /></font></td>
									</tr>
									<tr>
										<th><span class="requiredField">*</span>验证码:</th>
										<td><span class="fieldSet"> <input type="text"
												id="verifyCode" name="verifyCode" class="verifyCode"
												maxlength="4" autocomplete="off" /><img id="verifyCodeImg"
												class="verifyCodeImg"
												src="${pageContext.request.contextPath}/verifyCode"
												title="点击更换验证码" /></span> <font color="red"> <s:fielderror
													fieldName="verifyCode" /></font><s:actionerror/></td>
									</tr>
									<tr>
										<th>&nbsp;</th>
