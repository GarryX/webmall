...
<body>
	...
	<div class="container index">
		...
		<div class="span24">
			<div id="hotProduct" class="hotProduct clearfix">
				<div class="title" style="width:2300px" >
					<strong>热门商品</strong>
					<!-- <a  target="_blank"></a> -->
				</div>
				<ul class="tabContent">
					<s:iterator value="hotList" var="p">
						<li><a href="${pageContext.request.contextPath}/product_getById?id=<s:property value="#p.id"/>" target="_blank"><img
		...
		<div class="span24">
			<div id="newProduct" class="newProduct clearfix">
				...
				<!-- 					<div class="newProductAd">
						 ...
						 -->
				<ul class="tabContent" style="display: block;">
					<s:iterator value="latestList" var="p">
						<li><a href="${pageContext.request.contextPath}/product_getById?id=<s:property value="#p.id"/>" target="_blank"><img
								src="${pageContext.request.contextPath}/<s:property value="#p.image"/>"
	...
	<div class="container footer">
		...
		<div class="span24">
			<div class="copyright">Copyright © 2005-2015 翊华集团 版权所有</div>
		</div>
	</div>
</body>
</html>