				...
				<tbody>
					...
					<s:iterator value="model.items" var="item">
						<tr>
							...
							<td><a
								href="${pageContext.request.contextPath }/product_getById?id=<s:property value="#item.product.id" />"
								target="_blank"><s:property value="#item.product.name" /></a></td>
				...
				<div class="span24">
					<p>
						收货地址：<input name="address" type="text"
							...
							name="name" type="text"
							value="<s:property value="model.user.realName"/>"
