		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><select
					name="secondCategory.scId">
						<s:iterator var="sc" value="scList">
							<option value="<s:property value="#sc.scId"/>"
								<s:if test="#sc.scId == model.secondCategory.scId">selected</s:if>><s:property
									value="#sc.scName" /></option>
						</s:iterator>
				</select></td>
			</tr>
			<tr>
				...
				<td class="ta_01" bgColor="#ffffff" colspan="3"><textarea
						name="desc" rows="5" cols="30"><s:property
							value="model.desc" /></textarea></td>
			</tr>
			<tr>
